...
describe('SynthraV3Pool', () => {
  ...
  let pool0: MockTimeSynthraV3Pool
  let pool1: MockTimeSynthraV3Pool
  ...
  let swapTargetCallee: TestSynthraV3Callee
  let swapTargetRouter: TestSynthraV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeSynthraV3Pool, any]> => {
