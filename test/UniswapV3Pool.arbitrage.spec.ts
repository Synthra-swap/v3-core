...
import { SynthraV3PoolSwapTest } from '../typechain/SynthraV3PoolSwapTest'
...
describe('SynthraV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('SynthraV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as SynthraV3PoolSwapTest
          ...
          let tester: SynthraV3PoolSwapTest
